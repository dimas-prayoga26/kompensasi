          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
                ...
                <p class="mb-4">Masukkan email Anda dan kami akan mengirimkan petunjuk untuk mengatur ulang kata sandi Anda.</p>
                ...
                <div class="text-center">
                    <a href="{{ route('mahasiswa.login') }}" class="d-flex align-items-center justify-content-center">
