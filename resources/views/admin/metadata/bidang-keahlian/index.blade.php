...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <span class="text-muted fw-light">Settings /</span> Bidang Keahlian
    </h4>
      ...
      <div class="col-lg-12 mb-4 order-0">
          <div class="card">
            <div class="d-flex justify-content-between align-items-center p-3">
                  <h5 class="mb-0">Daftar Bidang Keahlian</h5>
    ...
    <div class="modal fade" id="modalTambahData" tabindex="-1" aria-labelledby="modalTambahDataLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form id="tambahData" enctype="multipart/form-data">
                ...
                <h5 class="modal-title" id="modalTambahDataLabel">Tambah Data Bidang Keahlian</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body">
                <div class="mb-3">
                    <label for="tambah_nama_keahlian" class="form-label">Nama Keahlian</label>
                    <input type="text" class="form-control" id="tambah_nama_keahlian" name="nama_keahlian" required>
                </div>
                </div>
    ...
    <div class="modal fade" id="modalEditData" tabindex="-1" aria-labelledby="modalEditDataLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form id="editData" enctype="multipart/form-data">
                <div class="modal-header">
                <h5 class="modal-title" id="modalEditDataLabel">Edit Data Bidang Keahlian</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body">
                <input type="hidden" id="edit_id_keahlian" name="id">
                <div class="mb-3">
                    <label for="edit_nama_keahlian" class="form-label">Nama Keahlian</label>
                    <input type="text" class="form-control" id="edit_nama_keahlian" name="nama_keahlian" required>
                </div>
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        $(document).ready(function () {
            table = $("#datatable").DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{{ route('bidang-keahlian.datatable') }}",
                },
                columnDefs: [
                    {
                        targets: 0,
        ...
        $("#simpanData").on("click", function (e) {
            ...
            $.ajax({
                url: "{{ route('bidang-keahlian.store') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        const urlEditUser = "{{ route('bidang-keahlian.show', ':id') }}";
        ...
        function editData(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === true) {
                        const bidang_keahlian = response.data;

                        $('#edit_nama_keahlian').val(bidang_keahlian.nama_keahlian);
        ...
        $("#updateData").on("click", function(e) {
            ...
            let url = "{{ route('bidang-keahlian.update', ':id') }}".replace(':id', id);
        ...
        const urlDeleteClass = "{{ route('bidang-keahlian.destroy', ':id') }}";
