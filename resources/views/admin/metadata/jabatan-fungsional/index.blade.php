...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <span class="text-muted fw-light">Settings /</span> Jabatan Fungsional
    </h4>
      ...
      <div class="col-lg-12 mb-4 order-0">
          <div class="card">
            <div class="d-flex justify-content-between align-items-center p-3">
                  <h5 class="mb-0">Daftar Data Jabatan Fungsional</h5>
                      ...
                      <div class="card-body">
                          <table id="datatable" class="table table-bordered text-nowrap w-100">
                              <thead>
                                  <tr>
                                      <th>No.</th>
                                      <th>Nama Jabatan Fungsioanal</th>
                                      <th>Aksi</th>
                                  </tr>
                              </thead>
                              <tbody>
    ...
    <div class="modal fade" id="modalTambahData" tabindex="-1" aria-labelledby="modalTambahDataLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form id="tambahData" enctype="multipart/form-data">
                ...
                <h5 class="modal-title" id="modalTambahDataLabel">Tambah Data Jabatan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body">
                <div class="mb-3">
                    <label for="tambah_nama_jabatan" class="form-label">Nama Jabatan</label>
                    <input type="text" class="form-control" id="tambah_nama_jabatan" name="nama_jabatan" required>
                </div>
                </div>
    ...
    <div class="modal fade" id="modalEditData" tabindex="-1" aria-labelledby="modalEditDataLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form id="editData" enctype="multipart/form-data">
                <div class="modal-header">
                <h5 class="modal-title" id="modalEditDataLabel">Edit Data Jabatan Fungsional</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        $(document).ready(function () {
            table = $("#datatable").DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{{ route('jabatan-fungsional.datatable') }}",
                },
                columnDefs: [
                    {
                        targets: 0,
        ...
        const urlEditUser = "{{ route('jabatan-fungsional.show', ':id') }}";
        ...
        $("#updateData").on("click", function(e) {
            ...
            let url = "{{ route('jabatan-fungsional.update', ':id') }}".replace(':id', id);
        ...
        const urlDeleteClass = "{{ route('jabatan-fungsional.destroy', ':id') }}";
